class Strings {
  ...
  static String remove_ads_year = 'One Year Ad Free (\$5.99)';
  static String remove_ads_permanent = 'Permanent Ad Free (\$12.99)';
  ...
  static String donateSmall = 'Morning Coffee (\$4.50)';
  static String donateMedium = 'Coffee and Cake (\$9.50)';
  static String donateLarge = 'Thanks For Lunch (\$17.50)';
